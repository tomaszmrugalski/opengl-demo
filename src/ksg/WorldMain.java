...
public class WorldMain implements GLEventListener
{
    ...
    public void display(GLAutoDrawable drawable) // metoda renderująca aktualną klatkę
        ...
        if (postProcessingActive)
        {
            ...
            gl.glTexCoord2f(0, 0);  gl.glVertex2f(0f, 0f);
            gl.glTexCoord2f(1, 0);  gl.glVertex2f(screenWidth+windowBordersWidth, 0f);
            gl.glTexCoord2f(1, 1);  gl.glVertex2f(screenWidth+windowBordersWidth, screenHeight+windowBordersHeight);
            gl.glTexCoord2f(0, 1);  gl.glVertex2f(0f, screenHeight+windowBordersHeight);
            gl.glEnd();
